...
// Load the persisted preference once at module init (text-only update —
// the *layout* direction for a persisted language is instead applied at
// startup in app/_layout.tsx, before first paint, since that doesn't need
// a restart to be correct).
...
export function useLanguage() {
  ...
  return { language: lang, setLanguage, toggleLanguage, t };
}
