...
insert into public.menu_items (title, subtitle, color, icon_key, size, action_type, action_value, sort_order) values
  ...
  ('احمي نفسك', 'خدمات قانونية متخصصة للعقارات', '#722F37', 'scale', 'half', 'whatsapp', 'مرحباً، أرغب في الاستفسار عن خدمة الاستشارات القانونية للعقارات (احمي نفسك) من تطبيق ديار توك', 3),
  ('اطلع لايف', 'ابدأ بث مباشر الآن', '#ef4444', 'camera', 'half', 'route', '/live/broadcast', 4),
  ('Repoo', 'تشطيبات وديكور', '#334155', 'building', 'half', 'whatsapp', 'مرحباً، أرغب في الاستفسار عن خدمات التشطيب والديكور (Repoo) من تطبيق ديار توك', 5),
  ('ونش ونقل أثاث', 'عرض سعر فوري', '#7c2d12', 'crane_truck', 'half', 'whatsapp', 'مرحباً، أرغب في طلب خدمة ونش ونقل الأثاث من تطبيق ديار توك', 6)
