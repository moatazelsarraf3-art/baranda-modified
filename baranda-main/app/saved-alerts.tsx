...
const styles = StyleSheet.create({
  ...
  empty: { textAlign: "center", color: "#9ca3af", marginTop: 40, fontSize: 12.5, lineHeight: 20, paddingHorizontal: 20 },
  row: {
    flexDirection: "row", alignItems: "center", gap: 10,
    backgroundColor: "#fafafa", borderRadius: 12, padding: 12, borderWidth: 1, borderColor: "#f1f5f9",
  },
  summary: { fontSize: 12, fontWeight: "700", color: "#111827", lineHeight: 18 },
