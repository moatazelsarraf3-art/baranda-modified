...
const styles = StyleSheet.create({
  ...
  propertyCard: { backgroundColor: "white", borderRadius: 12, overflow: "hidden", marginBottom: 6 },
  propertyCover: { height: 90 },
  propertyTitle: { fontSize: 12, fontWeight: "900", color: "#111827" },
  propertyPrice: { fontSize: 12, fontWeight: "900", color: "#22A652", marginTop: 3 },
  bubble: { maxWidth: "78%", borderRadius: 14, padding: 10 },
  bubbleReceived: { backgroundColor: "white", alignSelf: "flex-start", borderBottomLeftRadius: 2 },
  ...
  bubbleWhatsapp: { fontSize: 10, color: "#6b7280", opacity: 0.8, marginBottom: 4 },
  bubbleTextSent: { color: "white" },
  bubbleTime: { fontSize: 9.5, color: "#9ca3af", marginTop: 4, alignSelf: "flex-end" },
  ...
  pendingRow: { flexDirection: "row", gap: 8, padding: 10, backgroundColor: "white" },
  ...
  inputArea: { flexDirection: "row", alignItems: "flex-end", gap: 8, padding: 10, backgroundColor: "white", borderTopWidth: 1, borderTopColor: "#f3f4f6" },
  attachBtn: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: "#ecfdf5" },
  input: { flex: 1, backgroundColor: "#f3f4f6", borderRadius: 18, paddingVertical: 9, paddingHorizontal: 14, fontSize: 13, maxHeight: 100, color: "#111827" },
