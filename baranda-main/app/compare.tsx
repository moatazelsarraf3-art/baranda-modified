...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 15, fontWeight: "900", color: "#111827" },
  empty: { textAlign: "center", color: "#9ca3af", marginTop: 60, fontSize: 13 },
  cell: { height: ROW_HEIGHT, justifyContent: "center", borderBottomWidth: 1, borderBottomColor: "#f1f5f9" },
  cornerCell: { backgroundColor: "white" },
  labelCell: { paddingHorizontal: 10, backgroundColor: "#fafafa" },
  labelText: { fontSize: 11.5, color: "#6b7280", fontWeight: "700" },
  headerCell: { alignItems: "center", paddingTop: 8, paddingHorizontal: 8, gap: 6, borderRightWidth: 1, borderRightColor: "#f1f5f9" },
  thumb: { width: 64, height: 64, borderRadius: 10 },
  propTitle: { fontSize: 11, fontWeight: "800", color: "#111827", textAlign: "center" },
  removeBtn: {
  ...
  valueCell: { alignItems: "center", borderRightWidth: 1, borderRightColor: "#f1f5f9" },
  valueText: { fontSize: 12, color: "#111827", fontWeight: "700" },
});
