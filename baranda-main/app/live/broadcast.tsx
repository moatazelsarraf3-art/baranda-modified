...
const styles = StyleSheet.create({
  ...
  anonBlockedText: { color: "#d1d5db", fontSize: 14, fontWeight: "600", textAlign: "center", lineHeight: 21, marginBottom: 8 },
  ...
  viewersSheet: { backgroundColor: "#161616", borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 18, paddingBottom: 28 },
  viewersSheetHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 14 },
  viewersSheetTitle: { color: "white", fontSize: 15, fontWeight: "900" },
  viewersSheetClose: { color: "#9ca3af", fontSize: 13, fontWeight: "700" },
  noViewersText: { color: "#9ca3af", fontSize: 13, textAlign: "center", paddingVertical: 24 },
  viewerRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.06)" },
  ...
  viewerRowName: { flex: 1, color: "white", fontSize: 13, fontWeight: "700" },
  kickBtn: { backgroundColor: "rgba(239,68,68,0.15)", borderRadius: 999, paddingVertical: 6, paddingHorizontal: 14, borderWidth: 1, borderColor: "rgba(239,68,68,0.4)" },
