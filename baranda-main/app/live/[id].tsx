...
const styles = StyleSheet.create({
  ...
  consentCard: { width: "88%", maxWidth: 340, backgroundColor: "#161616", borderRadius: 20, padding: 24, alignItems: "center", gap: 14, borderWidth: 1, borderColor: "rgba(255,255,255,0.08)" },
  consentText: { color: "white", fontSize: 15, fontWeight: "700", textAlign: "center", lineHeight: 22 },
  ...
  consentBackBtnText: { color: "rgba(255,255,255,0.6)", fontWeight: "700", fontSize: 13 },
