...
function TabBtn({
  ...
  return (
    <Pressable style={[styles.tab, active && styles.tabActive]} onPress={onPress}>
      <Icon color={active ? "#22A652" : "#6b7280"} />
...
const styles = StyleSheet.create({
  ...
  avatarEditBadge: { position: "absolute", bottom: 2, right: 2, width: 24, height: 24, borderRadius: 12, backgroundColor: "#111827", borderWidth: 2, borderColor: "white", alignItems: "center", justifyContent: "center" },
  username: { fontSize: 15, fontWeight: "900", color: "#111827", marginTop: 10 },
  handle: { fontSize: 12, color: "#9ca3af", marginTop: 2 },
  bioBox: { paddingHorizontal: 24, paddingBottom: 16, alignItems: "center" },
  bioText: { fontSize: 12.5, color: "#6b7280", textAlign: "center" },
  tabs: { flexDirection: "row", borderTopWidth: 1, borderBottomWidth: 1, borderColor: "#e5e7eb" },
  tab: { flex: 1, alignItems: "center", gap: 4, paddingVertical: 12 },
  tabActive: { borderBottomWidth: 3, borderBottomColor: "#22A652" },
  tabLabel: { fontSize: 11, fontWeight: "900", color: "#6b7280" },
  tabLabelActive: { color: "#22A652" },
  tabCount: { fontSize: 10, backgroundColor: "#f3f4f6", color: "#6b7280", paddingVertical: 1, paddingHorizontal: 8, borderRadius: 999, overflow: "hidden" },
  tabCountActive: { backgroundColor: "#E8F7EE", color: "#22A652" },
  content: { padding: 16, minHeight: 300 },
  emptyState: { alignItems: "center", paddingTop: 50, gap: 10 },
  emptyTitle: { fontSize: 14, fontWeight: "900", color: "#374151" },
  ...
  sectionLabel: { fontSize: 12, fontWeight: "900", color: "#6b7280", marginBottom: 8 },
  myAdsGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  myAdCell: { width: "31%", aspectRatio: 0.8, borderRadius: 10, overflow: "hidden", backgroundColor: "#f3f4f6" },
  ...
  favCard: { backgroundColor: "#f9fafb", borderRadius: 14, padding: 14, marginBottom: 12 },
  favCardTop: { flexDirection: "row", justifyContent: "space-between", marginBottom: 6 },
  favCardTitle: { flex: 1, fontSize: 13, fontWeight: "900", color: "#111827" },
  favCardPrice: { fontSize: 12.5, fontWeight: "900", color: "#22A652" },
  favCardLoc: { fontSize: 11.5, color: "#6b7280", marginBottom: 10 },
  removeBtn: { backgroundColor: "#FEE2E2", borderRadius: 10, paddingVertical: 9, alignItems: "center" },
  removeBtnText: { color: "#991B1B", fontSize: 11.5, fontWeight: "900" },
  bioBackdrop: { ...StyleSheet.absoluteFillObject, backgroundColor: "rgba(0,0,0,0.5)" },
  bioModal: { position: "absolute", left: 20, right: 20, top: "35%", backgroundColor: "white", borderRadius: 16, padding: 18 },
  bioModalTitle: { fontSize: 14, fontWeight: "900", color: "#111827", marginBottom: 10 },
  bioInput: { backgroundColor: "#f3f4f6", borderRadius: 10, padding: 12, fontSize: 13, color: "#111827", minHeight: 80, textAlignVertical: "top" },
