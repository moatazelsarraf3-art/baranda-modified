...
const styles = StyleSheet.create({
  ...
  authRequiredTitle: { fontSize: 16, fontWeight: "900", color: "#111827", marginBottom: 8, textAlign: "center" },
  authRequiredSubtitle: { fontSize: 13, color: "#6b7280", textAlign: "center", marginBottom: 20 },
