...
const styles = StyleSheet.create({
  ...
  panel: { padding: 16, paddingBottom: 24, borderTopWidth: 1, borderTopColor: "#f3f4f6", gap: 10 },
  locateBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: "#ECFDF5", borderRadius: 12, paddingVertical: 12 },
  ...
  radiusLabel: { fontSize: 12.5, fontWeight: "800", color: "#374151" },
  radiusValue: { fontSize: 12.5, fontWeight: "900", color: "#22A652" },
  sliderTrack: { height: 30, justifyContent: "center" },
  sliderBase: { position: "absolute", left: 0, right: 0, height: 5, borderRadius: 3, backgroundColor: "#e5e7eb" },
  sliderFill: { position: "absolute", left: 0, height: 5, borderRadius: 3, backgroundColor: "#22A652" },
  sliderThumb: { position: "absolute", top: "50%", marginTop: -9, marginLeft: -9, width: 18, height: 18, borderRadius: 9, backgroundColor: "#22A652", borderWidth: 2, borderColor: "white" },
  actionsRow: { flexDirection: "row", gap: 10, marginTop: 8 },
  clearBtn: { flex: 1, borderRadius: 999, paddingVertical: 13, alignItems: "center", borderWidth: 1, borderColor: "#e5e7eb" },
  clearBtnText: { fontSize: 12.5, fontWeight: "900", color: "#374151" },
  applyBtn: { flex: 1, borderRadius: 999, paddingVertical: 13, alignItems: "center", backgroundColor: "#22A652" },
  applyBtnDisabled: { backgroundColor: "#a7d9bb" },
