      ...
      {selected && (
        ...
        >
          {selected.coverImage ? (
            ...
            <View style={[styles.previewImg, { backgroundColor: "#e5e7eb" }]} />
          )}
          <View style={{ flex: 1 }}>
...
const styles = StyleSheet.create({
  previewCard: {
    ...
    flexDirection: "row", gap: 10, backgroundColor: "white", borderRadius: 14, padding: 10,
    alignItems: "center",
  ...
  previewTitle: { fontSize: 12.5, fontWeight: "900", color: "#111827" },
  previewPrice: { fontSize: 12, fontWeight: "800", color: "#22A652", marginTop: 2 },
  previewLocation: { fontSize: 10.5, color: "#6b7280", marginTop: 2 },
  externalBtn: { paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10, backgroundColor: "#ECFDF5" },
