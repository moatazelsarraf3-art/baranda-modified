...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 14.5, fontWeight: "900", color: "#111827", textAlign: "center" },
  summary: { fontSize: 12, color: "#6b7280", textAlign: "center", marginTop: 8, lineHeight: 18 },
  label: { fontSize: 11.5, fontWeight: "800", color: "#374151", marginTop: 16, marginBottom: 6 },
  input: { backgroundColor: "#f9fafb", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 10, paddingVertical: 10, paddingHorizontal: 12, fontSize: 13 },
  actions: { flexDirection: "row", gap: 10, marginTop: 18 },
  cancelBtn: { flex: 1, alignItems: "center", paddingVertical: 12, borderRadius: 12, backgroundColor: "#f3f4f6" },
  cancelBtnText: { fontSize: 12.5, fontWeight: "800", color: "#374151" },
