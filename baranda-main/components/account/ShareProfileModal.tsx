...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 11.5, color: "#9ca3af", textAlign: "center", marginTop: 4, marginBottom: 6 },
  ...
  cellLabel: { fontSize: 10.5, fontWeight: "700", color: "#374151", textAlign: "center" },
  cancelBtn: { paddingVertical: 12, alignItems: "center", borderTopWidth: 1, borderTopColor: "#f3f4f6", marginTop: 4 },
  cancelBtnText: { fontSize: 13.5, fontWeight: "900", color: "#6b7280" },
});
