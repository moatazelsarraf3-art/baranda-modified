...
const styles = StyleSheet.create({
  card: {
    ...
    backgroundColor: "white", borderRadius: 14, paddingVertical: 8,
    shadowColor: "#000", shadowOpacity: 0.15, shadowRadius: 20, shadowOffset: { width: 0, height: 10 }, elevation: 10,
    borderWidth: 1, borderColor: "#f3f4f6",
  },
  title: { fontSize: 12, fontWeight: "900", color: "#9ca3af", paddingHorizontal: 14, paddingVertical: 6 },
  row: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 11, paddingHorizontal: 14 },
  rowText: { fontSize: 13, fontWeight: "700", color: "#374151" },
