              ...
              <View style={styles.row}>
                ...
                {tab === "following" && item.id !== user?.id && (
                  <Pressable style={styles.bellBtn} onPress={() => toggleNotify(item.id)}>
                    <Svg width={15} height={15} viewBox="0 0 24 24" fill="none" stroke={isNotifying ? "#22A652" : "#9ca3af"} strokeWidth={2}>
...
const styles = StyleSheet.create({
  ...
  sheet: {
    ...
    backgroundColor: "white", borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingTop: 8, paddingBottom: 24,
  },
  handle: { width: 40, height: 4, borderRadius: 2, backgroundColor: "#e5e7eb", alignSelf: "center", marginBottom: 10 },
  tabsRow: { flexDirection: "row", paddingHorizontal: 16, gap: 8, marginBottom: 8 },
  tabBtn: { flex: 1, alignItems: "center", paddingVertical: 10, borderRadius: 10, backgroundColor: "#f9fafb" },
  tabBtnActive: { backgroundColor: "#ecfdf5" },
  tabBtnText: { fontSize: 12.5, fontWeight: "800", color: "#6b7280" },
  tabBtnTextActive: { color: "#22A652" },
  emptyText: { textAlign: "center", color: "#9ca3af", fontSize: 12.5, paddingVertical: 30 },
  row: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 10, paddingHorizontal: 16 },
  rowMain: { flex: 1, flexDirection: "row", alignItems: "center", gap: 10 },
  avatarWrap: { width: 40, height: 40, borderRadius: 20, backgroundColor: "#ecfdf5", alignItems: "center", justifyContent: "center", overflow: "hidden" },
  avatarImg: { width: 40, height: 40, borderRadius: 20 },
  avatarInitial: { fontSize: 15, fontWeight: "900", color: "#22A652" },
  name: { fontSize: 13, fontWeight: "800", color: "#111827", flexShrink: 1 },
  bellBtn: { width: 30, height: 30, borderRadius: 15, alignItems: "center", justifyContent: "center", backgroundColor: "#f9fafb" },
