...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 14, fontWeight: "900", color: "#111827", textAlign: "center" },
  hint: { fontSize: 11, color: "#9ca3af", textAlign: "center", marginTop: 8, lineHeight: 17 },
  input: { marginTop: 14, minHeight: 90, borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 10, padding: 10, fontSize: 12.5, textAlignVertical: "top" },
