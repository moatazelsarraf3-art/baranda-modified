...
const styles = StyleSheet.create({
  ...
  closeBtn: { position: "absolute", top: 12, right: 12, width: 30, height: 30, borderRadius: 15, backgroundColor: "#f3f4f6", alignItems: "center", justifyContent: "center" },
  avatarWrap: { width: 68, height: 68, borderRadius: 34, backgroundColor: "#ecfdf5", alignItems: "center", justifyContent: "center", overflow: "hidden", marginTop: 8 },
  avatarImg: { width: 68, height: 68, borderRadius: 34 },
  avatarInitial: { fontSize: 26, fontWeight: "900", color: "#22A652" },
  name: { fontSize: 15, fontWeight: "900", color: "#111827", marginTop: 10 },
  ...
  verifyBadgeWarn: { backgroundColor: "#fffbeb" },
  verifyBadgeText: { fontSize: 11, fontWeight: "900", color: "#111827" },
  verifyWarning: { fontSize: 10.5, color: "#b45309", textAlign: "center", marginTop: 8, lineHeight: 16, paddingHorizontal: 8 },
  ...
  logoutBtn: { flexDirection: "row", alignItems: "center", gap: 8, marginTop: 18, backgroundColor: "#FEF2F2", borderRadius: 999, paddingVertical: 11, paddingHorizontal: 22 },
