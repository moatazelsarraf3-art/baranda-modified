      ...
      >
        <View style={styles.header}>
          ...
          <Pressable style={styles.dragBtn} onPress={onClose} hitSlop={6}>
            <Svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="#374151" strokeWidth={2}><Path d="M18 6L6 18M6 6l12 12" /></Svg>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 12, fontWeight: "900", color: "#374151" },
  ...
  tabLabel: { fontSize: 10, fontWeight: "800", color: "#6b7280" },
  ...
  filterChip: { backgroundColor: "#f3f4f6", borderRadius: 999, paddingVertical: 5, paddingHorizontal: 10 },
  filterChipActive: { backgroundColor: "#22A652" },
  filterChipText: { fontSize: 10.5, fontWeight: "800", color: "#374151" },
  filterChipTextActive: { color: "white" },
  markAllBtn: { paddingVertical: 5, paddingHorizontal: 8 },
  markAllBtnText: { fontSize: 10.5, fontWeight: "800", color: "#22A652" },
  item: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 10, paddingHorizontal: 12, borderBottomWidth: 1, borderBottomColor: "#f9fafb" },
  ...
  itemText: { fontSize: 12, color: "#374151", lineHeight: 17 },
  itemTime: { fontSize: 10, color: "#9ca3af", marginTop: 2 },
  empty: { textAlign: "center", color: "#9ca3af", fontSize: 12, padding: 24 },
