...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "#0b0b0b", alignItems: "center", justifyContent: "center", padding: 32, gap: 14 },
  iconWrap: { flexDirection: "row", gap: 20, marginBottom: 8, opacity: 0.9 },
  title: { color: "white", fontSize: 17, fontWeight: "900", textAlign: "center" },
  subtitle: { color: "#9ca3af", fontSize: 13, textAlign: "center", lineHeight: 20 },
  primaryBtn: {
