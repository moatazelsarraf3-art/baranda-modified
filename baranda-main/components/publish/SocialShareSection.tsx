...
const styles = StyleSheet.create({
  card: { backgroundColor: "#F9FAFB", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "#eef1f6", marginTop: 16 },
  title: { fontSize: 13.5, fontWeight: "900", color: "#111827" },
  subtitle: { fontSize: 11.5, color: "#6b7280", marginTop: 4, lineHeight: 17 },
  ...
  platformName: { fontSize: 12.5, fontWeight: "800", color: "#111827" },
  platformDesc: { fontSize: 11, color: "#6b7280", marginTop: 2, lineHeight: 16 },
  link: { color: "#22A652", fontWeight: "800" },
  note: { fontSize: 10.5, color: "#9ca3af", marginTop: 12, lineHeight: 16 },
});
