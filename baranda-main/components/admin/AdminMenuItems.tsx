  ...
  return (
    <View style={{ gap: 14 }}>
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="العنوان" value={title} onChangeText={setTitle} />
        <TextInput style={styles.input} placeholder="الوصف الفرعي (اختياري)" value={subtitle} onChangeText={setSubtitle} />
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ gap: 8 }}>
          {ICON_KEYS.map((k) => (
            <Pressable key={k} style={[styles.iconSwatch, iconKey === k && styles.iconSwatchActive]} onPress={() => setIconKey(k)}>
              <MenuIcon iconKey={k} size={22} color={iconKey === k ? "#22A652" : "#64748b"} />
            </Pressable>
          ))}
        </ScrollView>
        ...
        <TextInput style={styles.input} placeholder="اطلب الآن" value={ctaLabel} onChangeText={setCtaLabel} />
        ...
        <View style={{ flexDirection: "row", gap: 8, marginTop: 4 }}>
          {editingId && (
            <Pressable style={[styles.addBtn, { flex: 1, backgroundColor: "#f1f5f9" }]} onPress={resetForm}>
              <Text style={[styles.addBtnText, { color: "#334155" }]}>إلغاء</Text>
            </Pressable>
          )}
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 11.5, fontWeight: "800", color: "#64748b", marginBottom: 6, marginTop: 2 },
  hint: { fontSize: 10.5, color: "#94a3b8", marginBottom: 8, marginTop: -4 },
  ...
  iconSwatch: { width: 40, height: 40, borderRadius: 10, backgroundColor: "#f8fafc", alignItems: "center", justifyContent: "center", marginBottom: 10 },
  iconSwatchActive: { backgroundColor: "#ecfdf5", borderWidth: 1.5, borderColor: "#22A652" },
  placementRow: { flexDirection: "row", gap: 8, marginBottom: 10 },
  placementBtn: { flex: 1, alignItems: "center", paddingVertical: 9, borderRadius: 8, backgroundColor: "#f8fafc" },
  placementBtnActive: { backgroundColor: "#6366f1" },
  placementBtnText: { fontSize: 11, fontWeight: "800", color: "#64748b" },
  ...
  row: { flexDirection: "row", alignItems: "center", gap: 8, paddingVertical: 10, borderTopWidth: 1, borderTopColor: "#f1f5f9" },
  ...
  moveBtn: { width: 24, height: 24, borderRadius: 6, backgroundColor: "#f1f5f9", alignItems: "center", justifyContent: "center" },
  moveBtnText: { fontSize: 12, fontWeight: "900", color: "#334155" },
  editBtn: { backgroundColor: "#eef2ff", borderRadius: 999, paddingVertical: 6, paddingHorizontal: 10 },
  editBtnText: { color: "#6366f1", fontWeight: "900", fontSize: 10.5 },
  deleteBtn: { backgroundColor: "#FEF2F2", borderRadius: 999, paddingVertical: 6, paddingHorizontal: 10 },
