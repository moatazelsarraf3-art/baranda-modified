...
const styles = StyleSheet.create({
  ...
  linkInput: { flex: 1, backgroundColor: "#f9fafb", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 10, paddingVertical: 9, paddingHorizontal: 12, fontSize: 12.5, color: "#111827", textAlign: "left" },
  saveBtn: { backgroundColor: "#0f172a", borderRadius: 10, paddingHorizontal: 16, alignItems: "center", justifyContent: "center" },
