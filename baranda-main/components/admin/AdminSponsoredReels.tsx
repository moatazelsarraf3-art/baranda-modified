  ...
  return (
    <View style={{ gap: 14 }}>
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="ابحث عن الإعلان بالعنوان..." value={query} onChangeText={(v) => { setQuery(v); setSelectedId(null); }} />
        ...
        {selected && (
          <View style={{ marginTop: 10, gap: 10 }}>
            ...
            <TextInput style={styles.input} placeholder="هدف الوصول (reach) — عدد المشاهدين" keyboardType="number-pad" value={reachGoal} onChangeText={setReachGoal} />

            <View style={{ flexDirection: "row", gap: 8 }}>
              <TextInput style={[styles.input, { flex: 1 }]} placeholder="أقل عمر" keyboardType="number-pad" value={ageMin} onChangeText={setAgeMin} />
              <TextInput style={[styles.input, { flex: 1 }]} placeholder="أكبر عمر" keyboardType="number-pad" value={ageMax} onChangeText={setAgeMax} />
            </View>
...
const styles = StyleSheet.create({
  ...
  searchResultRow: { paddingVertical: 8, paddingHorizontal: 10, backgroundColor: "#f8fafc", borderRadius: 8, marginBottom: 4 },
  searchResultText: { fontSize: 12.5, fontWeight: "700", color: "#334155" },
  ...
  placementBtnText: { fontSize: 11.5, fontWeight: "800", color: "#64748b" },
  placementBtnTextActive: { color: "white" },
  disclaimer: { fontSize: 10.5, color: "#b45309", backgroundColor: "#fffbeb", borderRadius: 8, padding: 8, lineHeight: 15 },
  ...
  rowMeta: { fontSize: 10.5, color: "#94a3b8", marginTop: 2 },
