...
const styles = StyleSheet.create({
  row: { flexDirection: "row", alignItems: "flex-end", gap: 8, height: 140, borderBottomWidth: 1, borderBottomColor: "#e2e8f0", paddingBottom: 4 },
  ...
  label: { flex: 1, textAlign: "center", fontSize: 9.5, color: "#64748b", fontWeight: "700" },
});
