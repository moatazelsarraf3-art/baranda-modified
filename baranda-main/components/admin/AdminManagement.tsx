...
const styles = StyleSheet.create({
  ...
  input: { borderWidth: 1, borderColor: "#e2e8f0", borderRadius: 10, paddingVertical: 9, paddingHorizontal: 12, fontSize: 12.5 },
  searchResultRow: { paddingVertical: 8, paddingHorizontal: 10, backgroundColor: "#f8fafc", borderRadius: 8, marginTop: 6 },
  ...
  accessToggleText: { fontSize: 12, fontWeight: "700", color: "#334155" },
  ...
  adminRow: { flexDirection: "row", alignItems: "center", paddingVertical: 10, borderTopWidth: 1, borderTopColor: "#f1f5f9" },
  adminName: { fontSize: 12.5, fontWeight: "800", color: "#0f172a" },
  adminPerms: { fontSize: 11, color: "#64748b", marginTop: 2 },
  revokeBtn: { backgroundColor: "#FEF2F2", borderRadius: 999, paddingVertical: 6, paddingHorizontal: 12 },
