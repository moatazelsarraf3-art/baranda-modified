...
const styles = StyleSheet.create({
  ...
  statsCard: { backgroundColor: "white", borderRadius: 14, padding: 14, borderWidth: 1, borderColor: "#eef1f6" },
  statsTitle: { fontSize: 12.5, fontWeight: "900", color: "#0f172a", marginBottom: 10 },
  statsRow: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  statChip: { backgroundColor: "#f8fafc", borderRadius: 12, paddingVertical: 8, paddingHorizontal: 14, alignItems: "center", minWidth: 74 },
  statChipValue: { fontSize: 16, fontWeight: "900", color: "#4338ca" },
  statChipLabel: { fontSize: 10.5, color: "#64748b", marginTop: 2, fontWeight: "700" },
  rowFooter: { flexDirection: "row", alignItems: "center", flexWrap: "wrap", gap: 6, marginTop: 2 },
  platformBadge: { backgroundColor: "#eef2ff", borderRadius: 999, paddingVertical: 2, paddingHorizontal: 8 },
