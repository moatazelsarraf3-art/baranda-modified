...
// language (not the device's forced RTL flag): search/profile/like/share/
// save sit on the LEFT in Arabic and the RIGHT in English, mirrored by
// ReelInfoOverlay's price/details block doing the opposite on the same
// screen. Buttons top-to-bottom: search, seller avatar+follow, like, share, save.
...
export function ReelActionRail({
  ...
  onOpenSearch, onOpenSeller, onToggleFollow, onToggleLike, onShare, onToggleSave, onToggleCompare,
}: Props) {
  const { language } = useLanguage();
  const isAr = language !== "en";
  return (
    <View style={[styles.rail, isAr ? styles.railLeft : styles.railRight]}>
