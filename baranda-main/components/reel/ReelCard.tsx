...
export const ReelCard = memo(function ReelCard({
  ...
  function onVideoStatus(status: AVPlaybackStatus) {
    ...
    // ↔ #4 (تمرير تلقائي): isLooping بقى مربوط بـ !autoAdvance تحت — لما
    // يبقى معطّل، الفيديو بيوصل فعليًا لنهايته (didJustFinish) بدل ما
    // يلف تانى، فهنا اللحظة المناسبة نطلب من الشاشة الأب تنتقل للريل
    // اللي بعده.
