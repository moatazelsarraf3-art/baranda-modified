...
const styles = StyleSheet.create({
  ...
  location: { color: "white", fontSize: 11, opacity: 0.9, marginBottom: 4 },
  price: { color: "white", fontSize: 17, fontWeight: "900", marginBottom: 6 },
  specsRow: { flexDirection: "row", gap: 10, flexWrap: "wrap" },
  specText: { color: "white", fontSize: 10.5, fontWeight: "800", opacity: 0.95 },
});
