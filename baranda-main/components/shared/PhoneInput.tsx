...
const styles = StyleSheet.create({
  ...
  flag: { fontSize: 18 },
  callingCode: { fontSize: 13.5, color: "#111827", fontWeight: "700" },
  divider: { width: 1, alignSelf: "stretch", backgroundColor: "#e5e7eb", marginVertical: 8 },
  input: { flex: 1, paddingVertical: 12, paddingHorizontal: 14, fontSize: 13.5, color: "#111827" },
});
