      ...
      <View style={styles.container}>
        <View style={styles.topBar}>
          <Pressable onPress={onClose} hitSlop={8} style={styles.closeBtn}>
            <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke="#111827" strokeWidth={2.2} strokeLinecap="round">
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: "white", paddingTop: 54 },
  ...
  searchBox: {
    ...
    backgroundColor: "#f9fafb", borderWidth: 1, borderColor: "#e5e7eb", borderRadius: 12, paddingHorizontal: 12, paddingVertical: 10,
  },
  searchInput: { flex: 1, fontSize: 13.5, color: "#111827" },
  sectionHeader: { fontSize: 11.5, fontWeight: "800", color: "#9ca3af", paddingHorizontal: 16, paddingTop: 14, paddingBottom: 6 },
  row: { flexDirection: "row", alignItems: "center", gap: 10, paddingHorizontal: 16, paddingVertical: 12 },
  rowSelected: { backgroundColor: "#f0fdf4" },
  flag: { fontSize: 22 },
  countryName: { flex: 1, fontSize: 13.5, color: "#111827", fontWeight: "600" },
  callingCode: { fontSize: 13, color: "#6b7280", fontWeight: "700" },
});
