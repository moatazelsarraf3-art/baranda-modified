...
const styles = StyleSheet.create({
  ...
  card: {
    ...
    backgroundColor: "white", borderRadius: 18, padding: 22, alignItems: "center",
    shadowColor: "#000", shadowOpacity: 0.2, shadowRadius: 24, shadowOffset: { width: 0, height: 12 }, elevation: 14,
  },
  iconWrap: {
    width: 56, height: 56, borderRadius: 28, backgroundColor: "#EAF7EE",
    alignItems: "center", justifyContent: "center", marginBottom: 14,
  },
  title: { fontSize: 15, fontWeight: "900", color: "#111827", textAlign: "center", marginBottom: 8 },
  body: { fontSize: 12.5, fontWeight: "600", color: "#6b7280", textAlign: "center", lineHeight: 19, marginBottom: 18 },
  ...
  laterBtnText: { color: "#6b7280", fontWeight: "800", fontSize: 13 },
});
