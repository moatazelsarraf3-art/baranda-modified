    ...
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      ...
      <Animated.View style={[styles.sheet, { transform: [{ translateY }] }]} {...panResponder.panHandlers}>
        ...
        {items.map((item) => (
          ...
          >
            {item.icon?.({ width: 20, height: 20, viewBox: "0 0 24 24", fill: "none", stroke: item.danger ? "#991B1B" : "#111", strokeWidth: 2 })}
...
const styles = StyleSheet.create({
  ...
  title: { paddingHorizontal: 18, paddingBottom: 10, fontSize: 12.5, fontWeight: "900", color: "#6b7280", textAlign: "center" },
  item: { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 14, paddingHorizontal: 20 },
  itemText: { fontSize: 13.5, fontWeight: "900", color: "#111" },
